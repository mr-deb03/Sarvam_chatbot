...
import { loadClients, PAN_FIELDS } from '@/lib/clients';

export const runtime = 'nodejs';
export const dynamic = 'force-dynamic';

// Fetch the FULL client record matched by any holder PAN. (Admin only.)
// Used by the request detail panel to show the linked client's CAN profile.
export async function GET(req) {
  ...
  return Response.json({ client: match || null });
}
